 ...
 * 
 * @package KsfFA_ksf_FA_Performance
 * @version 2.4.3
 */

define('SS_ksf_FA_Performance', 130 << 8);
...
class hooks_ksf_FA_Performance extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Performance_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Performance] = _("");
        $security_areas['SA_ksf_FA_PerformanceVIEW'] = array(
            SS_ksf_FA_Performance | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_PerformanceMANAGE'] = array(
            SS_ksf_FA_Performance | 2, 
            _("Manage ")
        );
